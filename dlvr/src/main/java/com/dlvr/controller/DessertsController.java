...
public class DessertsController {
    ...
    public DessertsController(ProductRepository productRepository, UserRepository userRepository, BasketRepository basketRepository) {
	...
	public ModelAndView home(@PathVariable Long id, @RequestParam int number, HttpServletRequest request) {
		...
		ModelAndView mav = new ModelAndView("redirect:/desserts");
		return mav;
	}
}
