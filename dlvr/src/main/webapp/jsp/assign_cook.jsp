...
<div class="body">
	    ...
	    <div class="header-navigation">
	   	...
	   	<div class="container">
		  	...
		  	<form action="/account/admin_page/assign_cook/assign" method = POST>
    			...
    			<h2>Выберите повара</h2>
			  	<c:forEach var="cooklist" items="${cooklist}">    	
	                <p><input name="cook_id" type="radio" value="${cooklist.id}">Id повара: ${cooklist.id }
	                <br>
	                Телефон повара: ${cooklist.telephone}		            	
	                </p>
    			</c:forEach>
