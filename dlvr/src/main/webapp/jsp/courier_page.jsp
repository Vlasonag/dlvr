	    ...
	    <div class="header-navigation">
	   	...
	   	<div class="container">
	   		<div class="container-account-navigation"  style="margin-left: 18%;">
	   			<nobr>
		  			 <a href="/account/courier_page">Принять заказ</a>
		  		</nobr>
		  		<nobr>
		  			 <a href="/account/delivering_history">История заказов</a>
		  		</nobr>
		  		<nobr>
		  	...
		  	<form action="/account/courier_page/submit_order_delivering" method = POST style="width: 770px;">
		  		<h2>Выберите заказ, который вы собираетесь доставить и нажмите "Готово"</h2>
		  	...
		  	<form action="/account/courier_page/submit_order" method = POST style="width: 770px;">
		  		<h2>Выберите заказ, если вы уже доставили его и нажмите "Готово"</h2>
