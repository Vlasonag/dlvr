...
<div class="body">
	    ...
	    <div class="header-navigation">
	   	...
	   	<div class="container">
		  	...
		  	<form action="/account/admin_page/assign_courier/assign" method = POST>
    			...
    			<h2>Выберите курьера</h2>
			  	<c:forEach var="courierlist" items="${courierlist}">    	
	                <p><input name="courier_id" type="radio" value="${courierlist.id}">Id курьера: ${courierlist.id }
	                <br>
	                Телефон курьера: ${courierlist.telephone}		            	
	                </p>
    			</c:forEach>
