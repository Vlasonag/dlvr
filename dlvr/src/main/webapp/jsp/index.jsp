...
<div class="body">
	    ...
	    <div class="header-navigation">
	   	...
	   	<div class="container-account-info">
	   		<p style="font-size: 35px; text-align: center;">Этот сервис предназначен для дистанционного заказа еды. <br>
	   		Что бы заказать еду, перейдите по ссылкам навигации и добавьте в корзину, все что пожелаете. <br>
	   		Затем перейдите в раздел "Корзина" и заполните информацию о себе, или же зарегистрируйтесь и войдите в аккаунт, заполнив эту информацию предварительно.
